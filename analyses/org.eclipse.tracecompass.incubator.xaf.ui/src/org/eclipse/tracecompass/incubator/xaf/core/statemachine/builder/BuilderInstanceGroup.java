...
public class BuilderInstanceGroup {
     ...
     */
    public BuilderInstanceGroup(List<StateMachineBackendAnalysis> stateMachineBackendAnalysis, List<LttngKernelExecutionGraph> lttngKernelExecutionGraphModules) {
     ...
     *            the critical path analysis modules
     */
    public BuilderInstanceGroup(List<StateMachineBackendAnalysis> stateMachineBackendAnalysis, List<LttngKernelExecutionGraph> lttngKernelExecutionGraphModules, Collection<String> variableTypes, Collection<TimestampInterval> timeRanges) {
        this.stateMachineBackendAnalysis = stateMachineBackendAnalysis;
        this.lttngKernelExecutionGraphModules = lttngKernelExecutionGraphModules;
