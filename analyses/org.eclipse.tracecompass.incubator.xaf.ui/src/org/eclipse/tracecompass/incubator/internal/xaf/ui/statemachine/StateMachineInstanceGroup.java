...
public class StateMachineInstanceGroup {
    ...
    private final List<LttngKernelExecutionGraph> lttngKernelExecutionGraphModules;
    ...
    public StateMachineInstanceGroup(StateMachineTransition initialTransition) {
        ...
        this.lttngKernelExecutionGraphModules = null;
     ...
     */
    public StateMachineInstanceGroup(StateMachineTransition initialTransition, List<StateMachineBackendAnalysis> stateMachineBackendAnalysis, List<LttngKernelExecutionGraph> lttngKernelExecutionGraphModules) {
        List<StateMachineTransition> initialTransitionList = new ArrayList<>();
        initialTransitionList.add(initialTransition);
        this.initialTransitions.put(initialTransition.getEventName(), initialTransitionList);
     ...
     * @param lttngKernelExecutionGraphModules the critical path analysis modules
     */
    public StateMachineInstanceGroup(List<StateMachineTransition> initialTransitions, List<StateMachineBackendAnalysis> stateMachineBackendAnalysis, List<LttngKernelExecutionGraph> lttngKernelExecutionGraphModules) {
     ...
     * @param allInstancesValid Whether or not all the instances have to be considered valid for adaptive constraints
     */
    public StateMachineInstanceGroup(StateMachineTransition initialTransition, List<StateMachineBackendAnalysis> stateMachineBackendAnalysis, List<LttngKernelExecutionGraph> lttngKernelExecutionGraphModules, boolean allInstancesValid) {
        List<StateMachineTransition> initialTransitionList = new ArrayList<>();
        initialTransitionList.add(initialTransition);
        this.initialTransitions.put(initialTransition.getEventName(), initialTransitionList);
     ...
     * @param allInstancesValid Whether or not all the instances have to be considered valid for adaptive constraints
     */
    public StateMachineInstanceGroup(List<StateMachineTransition> initialTransitions, List<StateMachineBackendAnalysis> stateMachineBackendAnalysis, List<LttngKernelExecutionGraph> lttngKernelExecutionGraphModules, boolean allInstancesValid) {
        for (StateMachineTransition smt : initialTransitions) {
            List<StateMachineTransition> initialTransitionList = this.initialTransitions.get(smt.getEventName());
            if (initialTransitionList == null) {
                initialTransitionList = new ArrayList<>();
     ...
     */
    public List<LttngKernelExecutionGraph> getLttngKernelExecutionGraphModules() {
        return lttngKernelExecutionGraphModules;
    }
