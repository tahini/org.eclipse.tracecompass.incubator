 ...
 */
public class CriticalPathToCallGraph implements IWeightedTreeSet<Object, String, WeightedTree<Object>> {

    /**
     * An empty critical path
     */
    public static final CriticalPathToCallGraph EMPTY_CRIT_PATH_CG = new CriticalPathToCallGraph();
    ...
    private CriticalPathToCallGraph() {
     ...
     * @param graph
     */
    public CriticalPathToCallGraph(TmfGraph graph) {
