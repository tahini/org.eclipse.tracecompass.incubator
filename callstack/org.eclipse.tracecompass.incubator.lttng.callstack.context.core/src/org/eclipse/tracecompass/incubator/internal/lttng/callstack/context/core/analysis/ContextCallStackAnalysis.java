...
public class ContextCallStackAnalysis extends ProfilingCallGraphAnalysisModule {
    ...
    public ContextCallStackAnalysis() {
     // Create group descriptors
        fEventDescriptor = new CallStackGroupDescriptor("Events", null, false);
        fProcessDescriptor = new CallStackGroupDescriptor("Process", fEventDescriptor, false);
        fThreadDescriptor = new CallStackGroupDescriptor("Threads", fProcessDescriptor, false);
    }
