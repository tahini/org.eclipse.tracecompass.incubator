...
public final class FlameDefaultPalette implements IDataPalette {
    ...
    public OutputElementStyle getStyleFor(Object callsite) {
        ...
        if (callsite instanceof TimeGraphState) {
            ...
            return elStyle == null ? STYLE_MAP.computeIfAbsent("0", style -> new OutputElementStyle(style)) : elStyle;
        }
        return STYLE_MAP.computeIfAbsent("0", style -> new OutputElementStyle(style));
    }
