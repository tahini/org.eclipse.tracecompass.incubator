...
public class AggregatedCalledFunction extends AggregatedCallSite {
    ...
    public Map<String, IStatistics<ICalledFunction>> getStatistics() {
        ImmutableMap.Builder<String, IStatistics<ICalledFunction>> builder = new ImmutableMap.Builder<>();
        builder.put("Durations", getFunctionStatistics().getDurationStatistics());
        builder.put("Cpu times", getFunctionStatistics().getCpuTimesStatistics());
        builder.put("Self times", getFunctionStatistics().getSelfTimeStatistics());
