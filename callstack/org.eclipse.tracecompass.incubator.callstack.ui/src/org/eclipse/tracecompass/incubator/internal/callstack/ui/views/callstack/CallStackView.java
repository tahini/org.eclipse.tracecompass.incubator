...
public class CallStackView extends AbstractTimeGraphView {
    ...
    /** View ID. */
    public static final String ID = "org.eclipse.tracecompass.incubator.callstack.ui.views.callstack"; //$NON-NLS-1$
    ...
    protected void buildEntryList(final ITmfTrace trace, final ITmfTrace parentTrace, final IProgressMonitor monitor) {
        ...
        ICallStackProvider csProvider = getCallStackModule(trace);
        if (csProvider == null) {
...
//                    }
    ...
    private @Nullable ICallStackProvider getCallStackModule(@NonNull ITmfTrace trace) {
