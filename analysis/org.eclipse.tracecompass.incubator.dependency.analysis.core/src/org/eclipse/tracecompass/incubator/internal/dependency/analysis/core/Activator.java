...
package org.eclipse.tracecompass.incubator.internal.dependency.analysis.core;
...
public class Activator extends TraceCompassActivator {
    ...
    /** The plug-in ID */
    public static final String PLUGIN_ID = "org.eclipse.tracecompass.incubator.dependency.analysis.core"; //$NON-NLS-1$
